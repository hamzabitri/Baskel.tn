 ...
 * @author Omar
 */
public class AjouterTemoignageFrontController implements Initializable {
  ...
  @Override
    ...
    private void ajouter(ActionEvent event) throws IOException {
        ...
        try {
           ...
           Temoignage a = new Temoignage(idClient, tittle, champ, photo);

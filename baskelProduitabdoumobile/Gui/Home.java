...
//        if(isCurrentStats()) statsImage = selection;
        ...
        f.getToolbar().addMaterialCommandToLeftSideMenu("Produits ", FontImage.MATERIAL_EMOJI_EVENTS, e -> new AllProduits(username).show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Réclamation ", FontImage.MATERIAL_SMS, e -> new ReclamationForm(username).show());
...
public class Home extends Form {
 ...
 private Home current;
    ...
    public static void addMenu(Form f) {
        ...
        f.getToolbar().addMaterialCommandToLeftSideMenu("Home", FontImage.MATERIAL_BOOK, e-> new Home().show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Produits", FontImage.MATERIAL_BOOK, e-> new AllProduits().show());

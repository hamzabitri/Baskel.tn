...
public class DetailsProduit extends Form {
    ...
    int idE;
        public DetailsProduit(Form previous, Produit a, CategorieP c) throws ParseException {
                        try {
        ...
        String url=Statics.BASE_URL+"uploads/images/"+img;
        ...
        addAll(C2.add(imgv),new Label("Nom: "+a.getNom()),new Label(Prix),new Label("Catégorie : "+c.getNom()), new SpanLabel("Description : "+a.getDescription()),AddToCart);

...
public class Statics {
    public static final String BASE_URL="http://localhost/baskelttMobile/web/app_dev.php";
        public static final String IMAGE_URL="http://localhost/baskelttMobile/web/images/";

...
//        if(isCurrentStats()) statsImage = selection;
        ...
        f.getToolbar().addMaterialCommandToLeftSideMenu("Produits ", FontImage.MATERIAL_ADD_SHOPPING_CART, e -> new AllProduits(username).show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Mes Favoris ", FontImage.MATERIAL_ACCOUNT_CIRCLE, e -> new Wishlist(username).show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Evénement ", FontImage.MATERIAL_EMOJI_EVENTS, e -> new AllEvent(username).show());
        f.getToolbar().addMaterialCommandToLeftSideMenu("Carte des Stations ", FontImage.MATERIAL_EMOJI_TRANSPORTATION, e -> new MapForm(username).show());
